...
from . models import  DrugbankNome, AnvisaPrincipioativo, AnvisaNome, BigtableNomes, AnvisaNomePrincipioativo, DrugbankAnvisa, TesteInteracao, DrugbankInteracao
...
class Lista_TesteInteracao(ModelAdmin):
    list_display = ('item_1', 'item_2')
    list_per_page = 10

class Lista_Interacao(ModelAdmin):
    list_display = ('drugbank_id1', 'drugbank_id2')
    list_per_page = 100
...
admin.site.register(TesteInteracao, Lista_TesteInteracao)

admin.site.register(DrugbankInteracao, Lista_Interacao)
